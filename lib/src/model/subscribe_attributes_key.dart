...
class ReservedSubscriberAttribute {
  ...
  static const DEVICE_VERSION = ReservedSubscriberAttribute._('\$deviceVersion');
  ...
  static const ONESIGNAL_USER_ID = ReservedSubscriberAttribute._('\$onesignalUserId');
  static const AIRSHIP_CHANNEL_ID = ReservedSubscriberAttribute._('\$airshipChannelId');
  static const CLEVER_TAP_ID = ReservedSubscriberAttribute._('\$clevertapId');
  static const KOCHAVA_DEVICE_ID = ReservedSubscriberAttribute._('\$kochavaDeviceId');

  // Integration IDs
  static const MIXPANEL_DISTINCT_ID = ReservedSubscriberAttribute._('\$mixpanelDistinctId');
  static const FIREBASE_APP_INSTANCE_ID = ReservedSubscriberAttribute._('\$firebaseAppInstanceId');
  static const TENJIN_ANALYTICS_INSTALLATION_ID = ReservedSubscriberAttribute._('\$tenjinId');
