...
class PurchasesDart {
  ...
  static void setLogHandler(LogHandler logHandler) => Logger.logHandler = logHandler;
  ...
  @Deprecated('Login method using undocumented APIs which might change or stop working, set appUserId in configure instead, or to change id of current user, use updateAppUserId method.')
  ...
  static Future<bool> get isAnonymous async => _identityManager.currentUserIsAnonymous();
  ...
  static CustomerInfo? createCustomer(Map<String, dynamic> json) => _customerParser.createCustomer(RawCustomer.fromJson(json));
